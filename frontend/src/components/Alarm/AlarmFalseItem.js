    ...
    <div id='alarm-card'>
      <div id='alarm-content'>
        ...
        <div id='alarm-content-text'>
          ...
          <span
            onClick={
              item.type === 'follow' ? handleAlarmProfile : handleAlarmFeed
            }
          >
      ...
      >
        <div id="false-time-icon">
          <FiberManualRecordIcon
            sx={{ ml:3,mb:4,  fontSize: 15 }}
            id='alarm-icon'
          />
          <div >
          {feedUploadDate}
